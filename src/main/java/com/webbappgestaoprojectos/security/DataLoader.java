...
//
        projR.save(new Projecto("BHA", "Activo", 12000000.0, "Chiure e Ancuabe",
                "01/09/2020", "02/02/2022", "USD",8276626.0));
...
//        cr.save(c4);
//        Categoria c5 = new Categoria("DIRECTOR", 200000.0);
//        cr.save(c5);
//        Categoria c6 = new Categoria("GESTOR FINANCEIRO", 135000.0);
//        cr.save(c6);
